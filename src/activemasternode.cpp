...
//
// Bootup the Masternode, look for a 16120LUX input and register on the network
//
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            if(nDonate == 1){
                ...
                if(Params().NetworkID() == CChainParams::MAIN){
                    strDonationAddress = "LgViENrmgbK7hAMK8gmZMVn3m2SQeHEhiv";
                } else {
                    strDonationAddress = "LgViENrmgbK7hAMK8gmZMVn3m2SQeHEhiv";
                }
...
vector<COutput> CActiveMasternode::SelectCoinsMasternode()
{
    ...
    {
        if(out.tx->vout[out.i].nValue == 16120*COIN) { //exactly
